            ...
            {process.map((item, index) => (
              <Reveal key={item.title} delay={index * 150}>
                <div className="relative text-center">
                  ...
                  {/* Card */}
                  <div className="mt-6 h-full rounded-2xl border border-sky-100 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-sky-200 hover:shadow-md">
                    <p className="text-xs font-semibold uppercase tracking-widest text-sky-500">
                      Tahap {index + 1}
                    </p>
